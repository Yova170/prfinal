                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            while ($row = mysqli_fetch_assoc($resultCategorias)) {
                                // Ajustar la URL para incluir la categoría seleccionada en la búsqueda
                                echo "<li><a class='dropdown-item' href='main/vista/busqueda.php?busqueda={$row['nombre_categoria']}'>{$row['nombre_categoria']}</a></li>";
                            }
                            ?>
                        </ul>
                    </li>
