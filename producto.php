...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sqlProducto = "INSERT INTO productos (nombre_producto, descripcion_producto, producto_img, precio, id_categoria, id_marca) VALUES ('$nombreProducto', '$descripcionProducto', '$imagenProducto', $precio, $idCategoria, $idMarca)";
